...
export class ChatsController {
  ...
  getOrCreateDirect(
    ...
    return this.chatsService.getOrCreateDirectChat(
      createDirectChatDto,
      req.user,
    );
  }
  ...
  getOrCreateProjectGroup(
    @Request() req,
    @Body() createProjectGroupChatDto: CreateProjectGroupChatDto,
  ) {
    return this.chatsService.getOrCreateProjectGroupChat(
